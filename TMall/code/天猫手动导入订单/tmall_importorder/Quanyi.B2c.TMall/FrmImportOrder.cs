...
namespace Quanyi.B2c.Yaofangwang
{
    public partial class FrmImportOrder : Form
    {
        ...
        //private List<MedicineInfo> _productList;
        private ExcelUtils _excelUtils;
        private B2cPuller _puller;
        private FormMain _frmMain;

        public FrmImportOrder(FormMain frmMain)
        {
            InitializeComponent();
            //productList = new List<MedicineInfo>();
        ...
        private void backgroundWorker3_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                backgroundWorker3.ReportProgress(PROGRESS_ORDERINFOUPLOAD, "开始上传订单信息，请稍后...");
        ...
        private void FrmImportOrder_FormClosed(object sender, FormClosedEventArgs e)
        {
            _frmMain.RefreshOrder();
        }
    }
}
