                    ...
                    while((strLine=sr.ReadLine())!=null)
                    {
                        ...
                        if(isFirst)//建立表头
                        {
                            for (int i = 0; i < dtColumns; i++)
                            {
                                ...
                                {
                                    if (arrayLine[i].IndexOf("\"") == 0) arrayLine[i] = arrayLine[i].Substring(1, arrayLine[i].Length - 1);
                                    if (arrayLine[i].LastIndexOf("\"") == (arrayLine[i].Length - 1)) arrayLine[i] = arrayLine[i].Substring(0, arrayLine[i].Length - 1);
                                }
                                arrayLine[i].Replace("\"\"", "\"");
                        ...
                        else//表内容
                        {
                            ...
                            for (int i = 0; i < dtColumns; i++)
                            {
                                if (arrayLine[i].Length >= 2)
                                {
                                    arrayLine[i] = arrayLine[i].Substring(arrayLine[i].IndexOf("=") + 1, arrayLine[i].Length - arrayLine[i].IndexOf("=") - 1);
                                    if (arrayLine[i].IndexOf("\"") == 0) arrayLine[i] = arrayLine[i].Substring(1, arrayLine[i].Length - 1);
                                    if (arrayLine[i].LastIndexOf("\"") == (arrayLine[i].Length - 1)) arrayLine[i] = arrayLine[i].Substring(0, arrayLine[i].Length - 1);
                                }
                                arrayLine[i].Replace("\"\"", "\"");
